...
<html <?php language_attributes(); ?>>
    ...
    <head>
        ...
        if($_SERVER['REMOTE_ADDR'] == "182.184.89.153")

        {

            $temo = array();

//            $temo[0] = strtotime(date('2017-9-18'));

//            $temo[1] = strtotime(date('2017-9-19'));

//            $temo[2] = strtotime(date('2017-9-20'));

////            $temo[3] = strtotime(date('2017-9-21'));

////            $temo[4] = strtotime(date('2017-9-22'));

////            $temo[5] = strtotime(date('2017-9-23'));

////            $temo[6] = strtotime(date('2017-9-24'));

////            $temo[7] = strtotime(date('2017-9-25'));

////            $temo[8] = strtotime(date('2017-9-26'));

////            $temo[9] = strtotime(date('2017-9-27'));

////            $temo[10] = strtotime(date('2017-9-28'));

//            update_user_meta(10292, 'user_login_history', $temo);
        ...
        if (get_current_user_id()) {
            ...
            $current_user_meta = get_user_meta(get_current_user_id(), 'memb_tags');

//    var_dump(strpos($current_user_meta[0], 'Owner'));
            ...
            if (memb_hasAnyTags(33, $InfsID)) {

                ?> 

                <style>

                    #foundation-view{display:block}
...
?>
                    ...
                    <div class="logo_container">
                       ...
                       <a href="https://members.serviceadvisorpro.com/my-dashboard/">
