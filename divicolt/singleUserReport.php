<?php
/*
  Template Name: Single User Reporting
 */
if (!is_user_logged_in()) {
    header('Location: https://members.serviceadvisorpro.com');
    exit();
}
get_header();
            ...
            <article>
                <div class='entry-content'>
                    <div class='manage_wrap'>
                        <div class='manage_wrap'>
                            <div class='logo'> <img style="padding-top: 10px;padding-bottom: 20px;" src='<?php bloginfo('url'); ?>/wp-content/uploads/2017/11/My-Progress-Report-Header.png'> </div>
...
//                                    }
//                                }
                                $course_array = learndash_user_get_enrolled_courses(get_current_user_id());
//                                echo '<pre>';
...
//                                            }
                                ...
                                <div class="entry-content expandable" id="expandable-1">
                                    ...
                                    <div class="custom_width">
                                        <?php
                                          $user_tags = get_user_meta(get_current_user_id(),'memb_tag_ids');
                                           $user_tags = explode(',', $user_tags[0]);
                                        foreach ($course_array as $course) {
                                            $tags = wp_get_post_tags($course);
                                            $access = true;
//                                             var_dump($tags[0]->name  == 'manager');
//                                             var_dump(in_array('44', $user_tags));
//                                            $ll = true;
//                                            if(!$ll)
//                                            {
//                                                echo 'here';
...
//                                             echo $tags[0]->name.' = manager '.' && '.  var_dump(in_array('44', $user_tags));
//                                             if($tags[0]->name == 'manager' && (!in_array('44', $user_tags)));
//                                             {
////                                                 var_dump($access);
//                                                 echo 'yes';
//                                                 echo '<br>';
